...
export const metadata: Metadata = {
  title: "Changelog — ZiggyHR",
  description: "What's new in ZiggyHR. Feature updates, improvements, and release notes.",
}
    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="/" style={{ textDecoration: "none", fontSize: 22, fontWeight: 700, color: "#fff", letterSpacing: "-0.5px" }}>Ziggy<span style={{ color: ACCENT }}>HR</span></a>
          <div className="nav-links" style={{ display: "flex", gap: 28 }}>
            {[["Features", "/features"], ["Pricing", "/#pricing"], ["Contact", "/contact"], ["Blog", "/blog"], ["Sign In", "https://app.ziggyhr.com/login"]].map(([l, h]) => (
              <a key={l} href={h} style={{ color: "#888", fontSize: 15, textDecoration: "none", fontWeight: 500 }}>{l}</a>
            ))}
          </div>
          <a href="https://app.ziggyhr.com/signup" style={{ background: ACCENT, color: "#fff", textDecoration: "none", padding: "9px 20px", borderRadius: 8, fontSize: 14, fontWeight: 700 }}>
            Start Free Trial
          </a>
        </div>
      </nav>
        ...
        <div style={{ position: "relative", paddingLeft: 32 }}>
          ...
          <div style={{ position: "relative", marginBottom: 64 }}>
            ...
            <div style={{ background: "#111", border: "1px solid #1f1f1f", borderRadius: 16, padding: "28px 28px 24px" }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 16 }}>🚀 ZiggyHR is live</h3>
              <p style={{ fontSize: 14, color: "#666", marginBottom: 20, lineHeight: 1.6 }}>
                We've been building ZiggyHR for months. Today it's open for everyone. Here's everything you get on day one:
              </p>
              <ul style={{ listStyle: "disc", paddingLeft: 20, display: "flex", flexDirection: "column", gap: 6 }}>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Employee records and profile management"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Onboarding checklists with customizable steps"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"PTO request and approval workflow"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Performance review templates and goal tracking"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Job posting creation and applicant tracking pipeline"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"E-signature for offer letters and HR documents"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"Benefits enrollment tracking"}</li>
              <li style={{ fontSize: 15, color: "#ccc", lineHeight: 1.7, paddingLeft: 4 }}>{"HR analytics: headcount, turnover, and compensation reports"}</li>
              </ul>
            </div>
          </div>
